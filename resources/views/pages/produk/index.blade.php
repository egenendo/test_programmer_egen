                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="#" class="btn btn-success btn-sm float-right">Tambah</a>
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach ($produk as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" class="btn btn-block btn-primary btn-sm">Edit</a>
                                                    <a href="#" class="btn btn-block btn-danger btn-sm">Hapus</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
